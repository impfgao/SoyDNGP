...
class AvgPool2d(nn.Module):
    def __init__(self,channel,kernel_size,stride,padding=0,drop_out=0.3):
        super().__init__()
        if padding !=0 :
            self.block = nn.Sequential(
...
class SoyDNGP(nn.Module):
    def __init__(self):
        ...
        self.ca1 = CA_Block(32,206,206,reduction=4)
        self.p1 = AvgPool2d(channel=32,kernel_size=4,padding=1,stride=2)
        self.b2 = VGG_Block(32,64,3,1,1) 
        self.b3 = VGG_Block(64,64,3,1,1)
        ...
        self.b11 = VGG_Block(512,1024,3,1,1)
        ...
        self.b13 = VGG_Block(1024,2048,3,1,1)
        self.r6 = Rediual_Block(1024,2048,3,1,2)
        self.ca2 = CA_Block(2048,4,4,reduction=16)
        self.linear = Linear_(2048*4*4,1)
        self.relu = nn.ReLU()
    def forward(self,x):
